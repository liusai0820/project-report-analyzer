...
8. 流向分析需要包含三个层级：资金来源（包含政府资助资金、自筹资金）、一级科目、二级科目
9. 一级科目、二级科目的识别应该要从科目序号/缩进的不同来动态识别。比如序号如果出现“一、1、（1）”三种情形，则应该将“1”作为一级科目、“（1）”作为二级科目。
10.每个资金流向必须包含具体金额，确保source到target的金额加总平衡,资金流向按财务会计准则进行分类
  </rule>
